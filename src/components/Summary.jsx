...
export default function Summary({ userAnswers }) {
  ...
  const skippedQuestionsShare = Math.round(
  ...
  const incorrectAnswersShare =
    100 - (skippedQuestionsShare + correctAnswersShare);
  ...
  return (
    <div id="summary">
      ...
      <div id="summary-stats">
        <p>
          <span className="number">%{skippedQuestionsShare}</span>
      ...
      <ol>
        {userAnswers.map((answer, index) => {
          ...
          if (answer === "skipped") cssClass += " skipped";
